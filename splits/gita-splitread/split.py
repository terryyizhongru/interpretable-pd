#!/usr/bin/env python3
# filepath: /home/yzhong/gits/interpretable-pd/scripts/expand_monologue_parts.py
    ...
    for row in rows[1:]:
        ...
        for part in range(1, 11):
            ...
            for i in range(1, len(new_row)):
                if '_READTEXT' in new_row[i]:
                    new_row[i] = new_row[i].replace('_READTEXT', f'_READTEXT_part{part}')
